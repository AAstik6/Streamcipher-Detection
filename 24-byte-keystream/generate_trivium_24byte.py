...
# Generate one 24-byte keystream sample
def generate_trivium_keystream():
    ...
    bits = [trivium_round(state) for _ in range(24 * 8)]  # 24 bytes = 192 bits
...
def generate_trivium_samples():
    ...
    print(f"✅ Done! Saved {total_samples} TRIVIUM samples to '{filename}'")
